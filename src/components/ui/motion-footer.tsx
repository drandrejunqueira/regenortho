...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Ortopedia Regenerativa</span> <span className="text-primary/60">✦</span>
...
export function CinematicFooter() {
  ...
  return (
    <>
      ...
      >
        <footer className="fixed bottom-0 left-0 flex h-[80vh] w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper border-t border-border/10">
          ...
          <div className="absolute top-12 left-0 w-full overflow-hidden border-y border-border/50 bg-background/60 backdrop-blur-md py-4 z-10 -rotate-1 scale-105 shadow-2xl">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-16 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-5 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 w-full mt-2">
                <MagneticButton as="a" href="/site/a-clinica" className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground">
                  A Clínica
                </MagneticButton>
                <MagneticButton as="a" href="/site/tratamentos" className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground">
                  Tratamentos
                </MagneticButton>
                <MagneticButton as="a" href="/site/especialidades" className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground">
                  Especialidades
                </MagneticButton>
              </div>
            </div>
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-muted-foreground text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1">
              © {new Date().getFullYear()} REGENORTHO. Todos os direitos reservados.
            </div>

            {/* "Made with Love" Badge */}
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-border/50">
              <span className="text-muted-foreground text-[10px] md:text-xs font-bold uppercase tracking-widest">Clinical Atelier</span>
              ...
              <span className="text-foreground font-black text-xs md:text-sm tracking-normal ml-1">REGENORTHO</span>
            </div>
